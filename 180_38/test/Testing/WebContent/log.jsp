...
String uname = request.getParameter("user_name");    
  ...
  <h2 align="center">
		...
		<div class="row" align="center">
             ...
             <div class="col-xs-12 col-sm-6 col-md-6"><div class="form-group"><input name="register" value="New User" class="btn btn-primary btn-medium" onclick="document.location.href='reg.jsp';" tabindex="4"></div>
             </div>
         </div>
