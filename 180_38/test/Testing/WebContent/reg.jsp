...
%>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6" align="center"> <div class="form-group"><input type="submit" name="register" value="Create User" class="btn btn-primary btn-medium" tabindex="9"></div>
                </div>
