					...
					<form action ="">	
						...
						<h2 align="center"><a href="invitation.jsp?w_id=<%=(Integer)session.getAttribute("wedding_id") %>">Check Out Your Personalized Invitation</a></h2>
						 ...
						 <%
						 	...
						 	String web_url = "http://localhost:8080/Testing/invitation.jsp?w_id=" + (Integer)session.getAttribute("wedding_id");    
						    ...
						    connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/Wedding_Planner?useSSL=false",
						         ...
						         int updateQuery = 0;
						             ...
						             try{
						             String query0="select web_id from website where web_url ='"+web_url+"'";
						             ...
						             if(rs0!=null && rs0.next()){
						            	 String query1 = "update wedding set web_id="+rs0.getInt(1)+" where w_id = "+(Integer)session.getAttribute("wedding_id");
						            	 
						            	 pstatement = connection.prepareStatement(query1);
						            	 int insertquery = pstatement.executeUpdate();
						             }
