...
<div class="row-fluid">
			...
			<div class="row-fluid">		
		        <div class="span2">                           
                    <img src="images/girls.jpeg" class="img-polaroid" style="margin:5px 0px 15px;" alt="">   </div>          
                <div class="span10">            
                    <p>Vimmi works mostly on all of the guest interaction with the webpage. Making sure that the data regarding guest will be stored, retrieved, and display properly.</p>
                </div>		 
            </div>
			...
			<div class="row-fluid">		
		        <div class="span2">                           
                    <img src="images/girls.jpeg" class="img-polaroid" style="margin:5px 0px 15px;" alt="">   </div>          
                <div class="span10">              
                    <p>Ritu works mostly on componenets giving the users the option to choose, update, and delete any wedding components that have already been chosen.</p>
                </div>		 
            </div>
			...
			<div class="row-fluid">		
		        <div class="span2">                           
                    <img src="images/girls.jpeg" class="img-polaroid" style="margin:5px 0px 15px;" alt="">   </div>          
                <div class="span10">              
                   <p>Anushree has been actively involves in the EO creation, user creation (logging in, signing up, etc). Also, she works on the checklist to make sure all components needed are selected.</p>
                </div>		 
            </div>
			...
			<div class="row-fluid">		
		        <div class="span2">                           
                    <img src="images/guys1.png" class="img-polaroid" style="margin:5px 0px 15px;" alt="">   </div>          
                <div class="span10">              
                   <p>Polar mainly focus on the User Interface or the Web UI, the flow of the application and also creating the invitation for the user to share.</p>
                </div>		 
            </div>
                </div>
